...
index.php?username=**<sscript>alert(1)</sscript>** -> thats going to run javascript, and give us an alert pop-up box on the browser, and its gonna say '1' on the pop-up -> that is what reflective looks like.
